...
@Component({
  ...
  styleUrl: './profilo-cliente.component.css'
})
export class ProfiloClienteComponent implements OnInit {
  userDetails: any = {
    ...
    registrationNumber: '',
    reparto: { name: '' },
    profileImage: 'https://i.pinimg.com/736x/ef/b7/50/efb7509e73b3c4312ef59873879d2301.jpg',
    nameDepartment: ''
  };
      ...
      (data) => {
        if (data) {
          ...
          if (!this.userDetails.profileImage) {
            this.userDetails.profileImage = 'https://i.pinimg.com/736x/ef/b7/50/efb7509e73b3c4312ef59873879d2301.jpg';
          }
        }
