...
export class ProfiloComponent implements OnInit {
  userDetails: any = {
    ...
    registrationNumber: '',
    reparto: { name: '' },
    profileImage: 'https://i.pinimg.com/736x/57/38/48/573848ebfeef7475d442c045a5ba9643.jpg',
    nameDepartment: ''
  };
      ...
      (data) => {
        if (data) {
          ...
          if (!this.userDetails.profileImage) {
            this.userDetails.profileImage = 'https://i.pinimg.com/736x/57/38/48/573848ebfeef7475d442c045a5ba9643.jpg';
          }
        }
